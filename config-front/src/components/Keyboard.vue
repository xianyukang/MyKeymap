    ...
    return {
      lines: [
        [
          ...
          { key: 'U', disabled: false, used: true, disableAt: [] },
        ...
        [
          ...
          { key: 'S', disabled: false, used: true, disableAt: [] },
          { key: 'D', disabled: false, used: true },
          { key: 'F', disabled: false, used: true, disableAt: ['Capslock', 'CapslockF', 'Mode3R']},
          { key: 'G', disabled: false, used: true, disableAt: ['Mode3R'] },
          { key: 'H', disabled: false, used: true, disableAt: ['Mode9'] },
        ...
        [
          { key: 'Z', disabled: false, used: false, disableAt: ['Mode3R'] },
          { key: 'X', disabled: false, used: true, disableAt: ['Mode3R'] },
          { key: 'C', disabled: false, used: false, disableAt: ['Mode3R'] },
          { key: 'V', disabled: false, used: false, disableAt: ['Mode3R'] },
          { key: 'B', disabled: false, used: true, disableAt: ['Mode9'] },
          { key: 'N', disabled: false, used: true, disableAt: ['JMode', 'Mode9'] },
          { key: 'M', disabled: false, used: true, disableAt: ['Mode9'] },
          { key: ',', disabled: false, used: true, disableAt: ['Mode9'] },
          { key: '.', disabled: false, used: true, disableAt: ['Mode9'] },
          { key: '/', disabled: false, used: true, disableAt: ['Semicolon', 'Mode9'] },
        ],
        [
