...
InitKeymap()
{
  ...
  capsHook := InputHook("", "{CapsLock}{BackSpace}{Esc}", "bb,cc,cmd,dd,dm,ex,gj,kp,ld,lj,ly,mm,ms,no,rb,rex,se,sl,sp,ss,tm,vm,we,wf,wt")
...
InitTrayMenu() {
  ...
  A_IconTip := "MyKeymap 2.0-beta19 created by 咸鱼阿康"
